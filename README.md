...
ADP-JKR-Example Dotnet service.
...
| APPINSIGHTS_CLOUDROLE        | Role used for filtering metrics | no       |         |       | Set to `ADP-JKR-Example-local` in docker compose files                                                                |
...
`docker-compose -p ADP-JKR-Example-test -f docker-compose.yaml -f docker-compose.test.yaml up`
...
`docker-compose -p ADP-JKR-Example-test -f docker-compose.yaml -f docker-compose.test.watch.yaml up`
